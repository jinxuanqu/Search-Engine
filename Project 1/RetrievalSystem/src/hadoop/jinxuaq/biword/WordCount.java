 ...
 * 2.Map:
 * 		XML parse
 * 		Output: preword word-DocNo.		positionList
 * 3.Combine:
 * 		we want to combine the key with the same biword and DocNo.
 *		Output:	biword	 				sum-[DocNo:positionList]
 * 4.Reduce:
 * 		we want to reduce the key with the same word.
 * 		Output: biword, sum-[DocNo:positionList][DocNo:positionList][DocNo:positionList]
 * 
 * @author	Jinxuan Qu
...
public class WordCount {
	...
	public static class DocSumCombiner extends Reducer<Text, Text, Text, Text> {
		// combine the same biword and DocNo.
