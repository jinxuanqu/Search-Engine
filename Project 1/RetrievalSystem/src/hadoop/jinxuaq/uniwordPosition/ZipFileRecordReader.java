...
/**
 * copy right : https://github.com/cotdp/com-cotdp-hadoop This RecordReader
 * implementation extracts individual files from a ZIP file and hands them over
 * to the Mapper. The "key" is the decompressed file name, the "value" is the
 * file contents.
 */
public class ZipFileRecordReader extends RecordReader<Text, BytesWritable> {
	 ...
	 * readied for the Mapper. The contents of each file is held *in memory* in
	 * a BytesWritable object.
	 * 
