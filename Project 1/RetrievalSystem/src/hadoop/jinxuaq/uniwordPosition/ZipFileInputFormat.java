...
/**
 * copy right : https://github.com/cotdp/com-cotdp-hadoop Extends the basic
 * FileInputFormat class provided by Apache Hadoop to accept ZIP files. It
 * should be noted that ZIP files are not 'splittable' and each ZIP file will be
